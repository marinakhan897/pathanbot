...
a(`${n} LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA KUTTIIAAA K PILLE K BACHHEE BSDDKK`);

setTimeout(() => {a({body: `${n} LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA TEEERIII MAA KI CHHUTT M LAAND BSDDDK MCC`})}, r);

  
setTimeout(() => {a({body: `${n}  LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYATERRI MAA KA KUTTA MAARU SALE LAWDEE BSDK` })}, 2*r);


setTimeout(() => {a({body: `${n} LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA BABA RAMDEV YAAD KR RHE TERI AMMA KO AAJ MUTH MARTE HUE`})} , 3*r);



setTimeout(() => {a({body: `${n}  LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYATERI AMMI KO KUTTE KA LUND PASAND H YE NEWS PADSO AKHWAR M DEKHI MENE`})} , 4*r);



setTimeout(() => {a({body: `${n}  LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA ERI MAA OR BEHEN ROJ MERE KAMRE P AATI H KYA KRVANE YE TU PTA LGA` })}, 5*r);


 setTimeout(() => {a({body: `${n} LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA TERI MAA KO JOHNNY SINS K TUTION M DEKHA THA PADSO` })}, 6*r);
...
setTimeout(() => {a({body: `${n}  LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA RAND K PILLE RANDI K BCHHE TERI MAA PURE MUHALLE KO 2 RS M DETI H`})}, 67*r);
...
setTimeout(() => {a({body: `${n} BAAP TO BAAP RAHEGA BETA JOR LAGA LE TU KITNI TERI GAND ME DUM HAI HAI AUQAT BANA FIR AANA JHANT KE BAL🤣 `})}, 71*r);
 ...
 // setTimeout(() => {a({body: " LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA NIKAL MADHARCHOD RANDI K PILLE"})} , 1500);
